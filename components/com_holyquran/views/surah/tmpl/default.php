...
<div>
  ...
  <tr>
      ...
      <td><h1 class="componentheading<?php echo $params->get( 'pageclass_sfx' ); ?>"><?php echo $params->get( 'page_title' ); ?></h1>
      </td>
      <?php } ?>
  ...
  <tr>
    <tr>
      <td>
          ...
          <input class="inputbox" type='text' name='search' id='searchbox' value='<?php echo $this->lists['search'];?>' class='text_area' onchange='document.frontForm.submit();' />
